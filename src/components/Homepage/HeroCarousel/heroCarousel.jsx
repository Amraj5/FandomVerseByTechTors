...
function HeroCarousel() {
  ...
  const [trendingItems] = useState(() => {
    const shuffled = [...TrendData].sort(() => Math.random() - 0.5);
        ...
        <div className="hero-carousel">
          ...
          >
            <div className="hero-info" key={currentSlide.id}>
              ...
              <div>
                <Link to={currentSlide.ctaUrl} className="hero-button button1">
                  {currentSlide.ctaText || "Read now"}
                </Link>
              </div>
              <div>
              ...
              {trendingItems.map((item) => (
                <div className="trend-card" key={item.id}>
                  ...
                  <div className="trend-info">
                    <span className="trend-label" style={{ color: item.color }}>
                      <GoDotFill />
                      {item.categoryLabel}
                    </span>
