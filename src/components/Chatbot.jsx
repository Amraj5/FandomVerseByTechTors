...
const { quickReplies, rules, defaultResponse } = chatbotData.chatbotRules[0];
...
export default function Chatbot({ isOpen, onClose }) {
  ...
  return (
    /* Chat Window Panel — controlled by parent Layout */
    <div className={`chatbot-wrapper ${isOpen ? "is-open" : ""}`} aria-hidden={!isOpen}>
